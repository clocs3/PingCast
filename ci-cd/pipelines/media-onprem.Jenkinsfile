def IMAGE_DEFS = [
  [id: 'nginx-rtmp-onprem',        dir: 'media/onprem/nginx-rtmp'],
  [id: 'stream-controller-onprem', dir: 'media/onprem/stream-controller'],
  [id: 'ffmpeg-hls-onprem',        dir: 'media/onprem/ffmpeg'],
  [id: 's3-uploader',              dir: 'media/onprem/s3-uploader'],
  [id: 'nginx-hls-onprem',         dir: 'media/onprem/nginx-hls'],
  [id: 'hls-router-onprem',        dir: 'media/onprem/hls-router'],
]
...
pipeline {
  ...
  environment {
    ...
    DEPLOY_REPO_URL = "ssh://git@gitlab.example.com:2222/pingcast/deploy-vpc2.git"
    DEPLOY_BRANCH   = "main"
    SHARED_DEPLOY_REPO_URL = "ssh://git@gitlab.example.com:2222/pingcast/deploy-vpc1.git"
        ...
        withCredentials([
          ...
          sh '''
            ...
            sync_deploy_repo() {
              ...
              git commit -m "deploy: set onprem media image tags to ${GIT_SHA} (${image_names})"
            ...
            sync_deploy_repo "$DEPLOY_REPO_URL" "$DEPLOY_BRANCH" "deploy-repo-vpc2" "$BUILD_IMAGE_NAMES"
            ...
            if [ -n "$shared_images" ]; then
              sync_deploy_repo "$SHARED_DEPLOY_REPO_URL" "$SHARED_DEPLOY_BRANCH" "deploy-repo-vpc1" "$shared_images"
            fi
          '''
        }
      }
