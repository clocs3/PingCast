...
class Settings(BaseSettings):
    ...
    HLS_PVC_NAME: str = ""
    HLS_HOST_PATH: str = "/data/ns-media-onprem/hls"
    ...
    RTMP_HOST: str = "nginx-rtmp.ns-media-onprem.svc.cluster.local"
    RTMP_PORT: int = 1935
    RTMP_APP: str = "live"
    HLS_OUTPUT_ROOT: str = "/hls"
    HLS_CLEANUP_ON_START: bool = True
    HLS_CLEANUP_ON_EXIT: bool = True
    ENABLE_HLS_ROUTE_DISCOVERY: bool = True
    HLS_USE_NODE_INTERNAL_IP: bool = True
    HLS_NODE_ENDPOINT_PORT: int = 8081
    HLS_ROUTE_RECONCILE_SECONDS: int = 5
    HLS_ROUTE_RECONCILE_LOCK_SECONDS: int = 15
